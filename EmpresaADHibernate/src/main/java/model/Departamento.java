...
//	@OneToMany(mappedBy = "departamento", orphanRemoval = true)
	@OneToMany(mappedBy = "departamento") //mappedBy, define el objeto al que pertenece la relación
	//nos permite acceder a la información de empleados desde Departamentos
