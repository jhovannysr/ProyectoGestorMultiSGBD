...
public class DepartmentDAO {
	...
	/**
	 * (Naim) - Borrar departamento y actualizar los empleados del departamento borrado a null
	 * @param id
	 * @return
	 */
	public boolean delete(int id) {
	    ...
	    //Almacenamos el registro departamento en un objeto tipo Departamento
	    var d = queryByID(id);
